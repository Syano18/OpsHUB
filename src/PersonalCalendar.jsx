      ...
      <div className="flex-1 flex flex-col p-4 sm:p-2">
        <div className="w-full h-full flex flex-col gap-6">
          ...
          <div className="flex-1 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col min-h-0">
            ...
            {/* Calendar Cells */}
            <div className="flex-1 grid grid-cols-7 divide-x divide-y divide-slate-100 bg-slate-100/50" style={{ gridAutoRows: 'minmax(0, 1fr)' }}>
              {loading ? (
                ...
                gridDays.map((dateObj, idx) => {
                  if (!dateObj) {
                    return <div key={`empty-${idx}`} className="bg-slate-50/50"></div>;
                  }
                  ...
                  return (
                    <div
                      ...
                      className="bg-white p-2 flex flex-col overflow-hidden hover:bg-slate-50 transition-colors group cursor-pointer"
                    >
