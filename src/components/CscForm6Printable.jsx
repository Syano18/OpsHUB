      ...
      <div className="flex flex-col items-center mb-4 mt-2">
        <div className="flex items-center justify-between w-full px-12">
          ...
          <div className="text-center flex-1">
            ...
            <div className="font-serif text-[18pt] font-bold tracking-wide mt-1 text-slate-800">PHILIPPINE STATISTICS AUTHORITY</div>
            <div className="text-[10pt] mt-1 text-black">{officeDepartment}</div>
          </div>
          <div className="flex items-center gap-4 mr-8">
            <img src="/Bagong.png" alt="Bagong Pilipinas Logo" className="w-[80px] h-[80px] object-contain" />
          </div>
        </div>
        <div className="font-bold text-[18pt] mt-4 tracking-wide">APPLICATION FOR LEAVE</div>
      </div>
                ...
                <tbody>
                  <tr>
                    <td className="w-1/2 border-r border-black p-2 align-top">
                      <div>4. POSITION</div>
                      <div className="font-bold mt-2 border-b border-black pb-1 text-center uppercase">{position}</div>
                    </td>
                    <td className="w-1/2 p-2 align-top">
                      <div>5. SALARY</div>
                      <div className="font-bold mt-2 border-b border-black pb-1 text-center">{salary}</div>
                    </td>
                  </tr>
                </tbody>
              </table>
